...
<head>
    ...
    <title>Image Converter | NexusTools</title>
    ...
    <style>
        :root {
            ...
            --text-main: #f8fafc;
            --text-muted: #94a3b8;
            --primary-color: #cfe52b;
            --primary-hover: #b8cc26;
            --success: #10b981;
            --error: #ef4444;
        ...
        * {
        ...
        .format-option.active {
            ...
            border: 1px solid rgba(207, 229, 43, 0.3);
        }
        ...
        .upload-zone:hover, .upload-zone.dragover {
            ...
            background: rgba(207, 229, 43, 0.05);
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 10px 20px -10px rgba(207, 229, 43, 0.5);
        }
        ...
        .feature-icon {
            ...
            color: var(--primary-color);
            margin-bottom: 1.5rem;
            background: rgba(207, 229, 43, 0.1);
            width: 70px;
            height: 70px;
            display: flex;
            align-items: center;
...
<body>
    ...
    <section class="hero">
        ...
        <p>Seamlessly transform your images into PNG, JPG, WEBP, GIF, or BMP formats with no quality loss.</p>
    </section>
        ...
        <div class="converter-card">
            ...
            <div id="upload-ui">
                <div class="upload-zone" id="drop-zone">
                    ...
                    <h3 class="upload-text" id="upload-text">Choose Image file</h3>
                    <p class="upload-hint" id="upload-hint">or drag & drop your image here</p>
            ...
            <div class="status-container" id="processing-ui">
                <div class="file-info">
                    <i class="fa-regular fa-image" id="processing-icon"></i>
                    <span id="filename-display">image.png</span>
                </div>
                
                <h3 id="progress-title" style="margin-bottom: 0.5rem;">Uploading Image</h3>
            ...
            <div class="status-container" id="success-ui">
                ...
                <h3 style="margin-bottom: 2rem; font-size: 1.8rem;">Your image is ready!</h3>
...
<section class="features">
    <h2 class="section-title">Why choose our Image Converter?</h2>
    <div class="features-grid">
        <div class="feature-card">
            <div class="feature-icon"><i class="fa-solid fa-bolt"></i></div>
            <h3>Fast & Easy</h3>
            <p>Upload your image in any standard format and convert it instantly right from your browser.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon"><i class="fa-solid fa-shield-halved"></i></div>
            <h3>100% Secure</h3>
            <p>Your files are safely processed and automatically deleted from our servers shortly after conversion.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon"><i class="fa-solid fa-image"></i></div>
            <h3>High Quality</h3>
            <p>We preserve image resolution and quality during conversion and support transparent background handling.</p>
        </div>
    </div>
</section>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function uploadFile(formData) {
                ...
                const jobId = 'img_' + Math.random().toString(36).substr(2, 9);
                ...
                // Reset Progress UI
                progressTitle.textContent = "Uploading Image";
                ...
                xhr.upload.onprogress = function(e) {
                    if (e.lengthComputable) {
                        ...
                        if (percentComplete >= 100) {
                            progressTitle.textContent = "Converting Image";
                            progressDesc.textContent = "Processing format and quality... Phase 2 of 2";
                            progressFill.style.width = '0%';
                            progressFill.style.background = '#cfe52b'; 
                            progressPercentage.style.color = '#cfe52b';
                            progressPercentage.textContent = '0%';
