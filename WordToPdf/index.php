...
<head>
    ...
    <title>Word to PDF Converter | NexusTools</title>
...
<body>
    ...
    <section class="hero">
        ...
        <p>Transform your non-editable Word documents into beautifully formatted PDF files in seconds. High quality, 100% free, and completely secure.</p>
    </section>
        ...
        <div class="converter-card">
            ...
            <div id="upload-ui">
                <div class="upload-zone" id="drop-zone">
                    ...
                    <h3 class="upload-text">Choose Word file</h3>
                    <p class="upload-hint">or drop DOCX here</p>
            ...
            <div class="status-container" id="processing-ui">
                <div class="file-info">
                    ...
                    <span id="filename-display">document.docx</span>
                </div>
            ...
            <div class="status-container" id="success-ui">
                ...
                <h3 style="margin-bottom: 2rem; font-size: 1.8rem;">Your PDF file is ready!</h3>
    ...
    <section class="features">
        ...
        <div class="features-grid">
            <div class="feature-card">
                ...
                <h3>Fast & Easy</h3>
                <p>Simply drag and drop your Word document and download your PDF in seconds. No registration required.</p>
            </div>
            <div class="feature-card">
            ...
            <div class="feature-card">
                ...
                <h3>High Quality</h3>
                <p>Convert your Word documents to PDF without losing formatting, layouts, or tables.</p>
            </div>
        </div>
    </section>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function uploadFile(formData) {
                ...
                const jobId = 'word_' + Math.random().toString(36).substr(2, 9);
                ...
                xhr.upload.onprogress = function(e) {
                    if (e.lengthComputable) {
                        ...
                        if (percentComplete >= 100) {
                            progressTitle.textContent = "Converting to PDF";
